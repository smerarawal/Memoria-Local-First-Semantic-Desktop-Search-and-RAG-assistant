  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '0.4rem' }}>Configuration</p>
        <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: '1.6rem', fontWeight: 400, letterSpacing: '0.01em' }}>Settings</h2>
      </div>
              ...
              <>
                ...
                {status.pending_files > 0 && (
                  <div className="indexing-hint">
                    <span>⏳</span>
                    <span><strong>{status.pending_files} file{status.pending_files > 1 ? 's' : ''}</strong> being embedded in the background. This may take a moment on first run while the ML model downloads (~85 MB). Search will work once they show as indexed.</span>
                  </div>
                )}
